...
(A Product Hunt tab was tried and pulled — their site blocks GitHub Actions' shared IP ranges at the WAF level, confirmed via two live runs with a 403, so it would have shipped as a permanently-empty tab.)
